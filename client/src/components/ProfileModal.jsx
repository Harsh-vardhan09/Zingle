  ...
  return (
    <section className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
      <div className='max-w-2xl sm-py-6 mx-auto'>
            <div className='bg-white rouneded-lg shadow p-6'>
                ...
                <form action="" className='space-y-4' onSubmit={e=>toast.promise(handleSaveProfile(e),{loading:"saving..."})}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <div className='group/profile relative'>
                                ...
                                <div className='absolute hidden group-hover/profile:flex top-0 left-0 right-0 bottom-0 rounded-full bg-black/20  items-center justify-center'>
                    ...
                    {/* Cover */}
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor="cover_photo" className='block text-sm font-sm font-medium text-gray-700 mb-1'>
                            Cover Image
                            ...
                            <div className='group/cover relative'>
                                <img src={editForm.cover_photo?URL.createObjectURL(editForm.cover_photo):user.cover_photo} alt="" className='w-80 h-40 bg-linear-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2 rounded' />
                                <div className='absolute hidden group-hover/cover:flex top-0 left-0 right-0 bottom-0 rounded-lg bg-black/20  items-center justify-center'>
                                    <Pencil className='w-5 h-5 text-white'/>
                                </div>
                            </div>
                        </label>
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your Address' onChange={(e)=>setEditForm({...editForm,location:e.target.value})} value={editForm.location}/>
                    </div>

                    <div className='flex justify-end space-x-3 pt-6'>
                        <button type='button' onClick={()=>setShowEdit(false)} className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-100 transition-colors cursor-pointer'>Cancel</button>
                        <button type='submit' className='px-4 py-3 bg-linear-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer'>Save Changes</button>
                    </div>
