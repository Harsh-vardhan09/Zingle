...
const StoriesBar = () => {
  ...
  return (
    <section className="w-screen sm:w-[calc(100vw-240px)] lg:max-e-2xl no-scrollbar overflow-x-auto px-4">
      <div className="flex gap-4 pb-4">
        {/* Add story card */}
        <div className="rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-3/4 cursor-pointer hover:shadows-lg transition-all duration-200 border-2 border-dashed border-indigo-300 bg-linear-to-b from-indigo-50 to-white ">
