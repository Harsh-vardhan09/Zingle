...
const PostCard = ({post}) => {
  ...
  return (
    <section className='bg-white rounded-xl shadow p-4 space-y-4 w-full max-w-2xl'>
        {/* user Info */}
        <div  onClick={()=>navigate('/profile/'+post.user._id)} className='inline-flex items-center gap-3 cursor-pointer'>
            ...
            <div >
                <div className='flex items-center space-x-1'>
                    ...
                    <BadgeCheck className='w-2 h-4 text-blue-500'/>
                </div>
        ...
        <div className='grid grid-col gap-2'>
            ...
            <div className='flex items-center gap-4 text-gray-600 text-sm pt-2 border-t border-gray-300'>
                <div className='flex items-center gap-1'> 
                    <Heart className={`w-4 h-4 cursoe-pointer ${likes.includes(currentUser._id)&& 'text-red-500 fill-red-500'}`} onClick={handleLike}/>
