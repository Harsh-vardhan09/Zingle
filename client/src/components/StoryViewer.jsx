...
const StoryViewer = ({viewStory,setViewStory}) => {
    ...
    const renderContent=()=>{
        switch (viewStory.media_type) {
            case 'image':
                ...
                case 'video':
                return(
                    <video src={viewStory.media_url} 
                    className='max-h-screen' onEnded={()=>setViewStory(null)} controls autoPlay/>
                )
  ...
  return (
    <section className='fixed inset-0 h-screen bg-black bg-opacity-90 z-110 flex items-center justify-center' style={{background:viewStory.media_type==='text'?viewStory.background_color:'#000000'}}>
