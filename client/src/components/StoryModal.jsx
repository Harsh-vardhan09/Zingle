...
const StoryModal = ({ setShowModal, fetchStories }) => {
    ...
    if (file) {
      if (file.type.startsWith("video")) {
        if (file.size > MAX_VIDEO_SIZE_MB * 1024 * 1024) {
          toast.error(`vidso size cannot be bigger than ${MAX_VIDEO_SIZE_MB}`);
          setMedia(null);
          setPreviewUrl(null);
          return;
        }
  ...
  return (
    <section className="fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4">
