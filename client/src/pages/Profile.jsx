...
const Profile = () => {
  ...
  return user?(
    <section className='relative h-full overflow-y-scroll bg-gray-50 p-6'>
        ...
        <div className='mt-6'>
          <div className='bg-white flex rounded-xl shadow p-1 max-w-md mx-auto'>
            {["posts","media","likes"].map((tab)=>(
              <button on onClick={()=>setActiveTab(tab)} key={tab} className={`flex-1 px-4 py-2 text-sm font-medium rounded-lg transition-colors cursor-pointer ${activeTab===tab?"bg-indigo-600 text-white":"text-gray-600 hover:text-gray-900"}`}>
