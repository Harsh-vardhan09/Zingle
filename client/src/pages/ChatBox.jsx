...
import { Image, SendHorizonal, SendIcon } from "lucide-react";
  ...
  return (
    user && (
      <section className="flex flex-col h-screen">
        <div className="flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-linear-to-r from-indigo-50 border-b border-gray-300">
          <img
        ...
        {/* innput message */}
        <div className="px-4">
          <div className="flex items-center ga-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5">
            <input
              type="text"
