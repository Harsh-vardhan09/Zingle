      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">
            Manage your netwrok and discover new connections
          </p>
        </div>
                  ...
                  <div className="flex max-sm:flex-col gap-2 mt-4">
                    ...
                    {currentTab === 'connections' && (
                      <button
                        ...
                        className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer flex justify-center items-center gap-1"
                      >
